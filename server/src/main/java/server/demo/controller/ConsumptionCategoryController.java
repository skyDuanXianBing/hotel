...
public class ConsumptionCategoryController {
     ...
     */
    @GetMapping
    public ResponseEntity<ApiResponse<List<ConsumptionCategory>>> getAll(@RequestParam Long userId) {
        try {
            List<ConsumptionCategory> categories = categoryService.getAllByUserId(userId);
    ...
    public ResponseEntity<ApiResponse<ConsumptionCategory>> create(
        ...
        try {
            ConsumptionCategory category = new ConsumptionCategory(userId, dto.getName());
