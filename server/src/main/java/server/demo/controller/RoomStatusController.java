...
public class RoomStatusController {
    ...
    public ApiResponse<RoomStatusCalendarDTO> getRoomStatusCalendar(
        ...
        try {
            RoomStatusCalendarDTO calendarData = roomStatusService.getRoomStatusCalendar(startDate, endDate);
    ...
    public ApiResponse<RoomStatusStatisticsDTO> getRoomStatusStatistics(
        ...
        try {
            ...
            RoomStatusStatisticsDTO statistics = roomStatusService.getRoomStatusStatistics(targetDate);
